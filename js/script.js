...
fetch(DATA_URL)
        ...
        .then(data => {
            ...
            students.forEach(students => {
                ...
                name.textContent = students.name + " " + students.lastname + " " + students.age;
                studentsDiv.appendChild(name);
                
                container.appendChild(studentsDiv);
            });
        })
        .catch(error => {
            console.error("Error al cargar los nombres de estudiantes:", error);
        });